  ...
  <div class="app-header">
    ...
    <div class="app-header-right">
      ...
      <button class="profile-btn">
        <img src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.formula1.com%2Fen%2Fdrivers%2Fhall-of-fame%2FAyrton_Senna.html&psig=AOvVaw0pU2UfyG6PThL-1Ncx-5qw&ust=1676043036524000&source=images&cd=vfe&ved=0CBAQjRxqFwoTCMjtx4bhiP0CFQAAAAAdAAAAABAR" />
        <span>Ayrton Senna B.</span>
      </button>
    </div>
...
<div class="messages-section">
  ...
  <div class="messages">
    <div class="message-box">
      ...
      <div class="message-content">
        <div class="message-header">
          <div class="name">Angelita Wijaya</div>
    ...
    <div class="message-box">
      ...
      <div class="message-content">
        <div class="message-header">
          <div class="name">Mark Zuckerburg</div>
          <div class="star-checkbox">
    ...
    <div class="message-box">
      ...
      <div class="message-content">
        <div class="message-header">
          <div class="name">David Blanc</div>
          <div class="star-checkbox">
    ...
    <div class="message-box">
      ...
      <div class="message-content">
        <div class="message-header">
          <div class="name">Abyra Muntu</div>
          <div class="star-checkbox">
